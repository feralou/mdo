...
-->
    <link href='http://fonts.googleapis.com/css?family=Open+Sans:300,600&v2' rel='stylesheet' type='text/css'>
    <link rel="stylesheet/less" type="text/css" media="all" href="<?php bloginfo('stylesheet_directory'); ?>/public/less/mdo.less">
    <script type="text/javascript" src="<?php bloginfo('stylesheet_directory'); ?>/public/js/less-1.1.4.min.js"></script>
  ...
  <body class="<?php echo $browser ?>">
    ...
    <header>
      <a href="<?php echo home_url('/'); ?>" title="<?php bloginfo('name'); ?>">
        <img src="<?php bloginfo('stylesheet_directory'); ?>/images/mdo-shades.png" alt="Mark Otto" />
      </a>
      <nav>
        <ul>
          <li></li>
