<?php
	...
	$config = array(
		// REQUIRED VALUES ------------------------------------
		"twitter_screenname" => "mdo", // Your Twitter screen name
		"timezone"           => "America/Los_Angeles", // Choose one of these: http://php.net/manual/en/timezones.php
		"path"               => "/tweets", // Where's your twitter installation on your domain? No end slash, please.
		// Database values
		"db"                 => array(
			"hostname"       => "internal-db.s9645.gridserver.com", // The hostname of your database server. Usually "localhost"
			"username"       => "db9645", // The username to log in to your database
			"password"       => "QR4BbPpgcRQI0vZErJWe", // The password to log in to your database
			"database"       => "db9645_twitter_tweetnest", // The database name
		...
		"maintenance_http_password" => "O1t8t9o11986@!", 
